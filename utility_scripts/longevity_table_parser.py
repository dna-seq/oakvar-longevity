...
dbsnp_conn = sqlite3.connect(r"D:/dev/oakVar/modules/annotators/dbsnp/data/dbsnp.sqlite")
dbsnp_tables = getChromTables(dbsnp_conn, sql_table_names)
create_dbsnp_index(dbsnp_conn, dbsnp_tables)

conn = sqlite3.connect(r"longevitymap.sqlite")
cursor = conn.cursor()
...
df = pd.read_csv("longevitymap.tsv", sep="\t")
idIndex = 0
