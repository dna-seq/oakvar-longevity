...
UPDATE variant SET identifier='rs1800796' WHERE (identifier='Rs1800796' AND gene_id=(SELECT id FROM gene WHERE symbol='IL6')); -- unconventional RS (uppercase)
UPDATE variant SET identifier='rs1799889' WHERE (identifier='1-bp guanine deletion/insertion (4G/5G)' AND gene_id=(SELECT id FROM gene WHERE symbol='SERPINE1')); -- https://www.snpedia.com/index.php/Rs1799889
UPDATE variant SET identifier='rs1800795' WHERE (identifier='-174C/G' AND gene_id=(SELECT id FROM gene WHERE symbol='IL6')); -- https://www.snpedia.com/index.php/Rs1800795 
UPDATE variant SET identifier='rs61733139' WHERE (identifier='Q95H' AND gene_id=(SELECT id FROM gene WHERE symbol='MTTP')); -- https://www.aginginterventionfoundation.org/GenomicsNotes.htm
UPDATE variant SET identifier='rs1800629' WHERE (identifier='-308G/A' AND gene_id=(SELECT id FROM gene WHERE symbol='TNF'));  -- https://www.dovepress.com/effect-of-tnf-alpha-minus308ga-rs1800629-promoter-polymorphism-on-the--peer-reviewed-fulltext-article-CCID https://www.snpedia.com/index.php/Rs1800629
UPDATE variant SET identifier='rs1799752' WHERE (identifier='I/D' AND gene_id=(SELECT id FROM gene WHERE symbol='ACE')); -- https://pubmed.ncbi.nlm.nih.gov/11091119/ https://www.snpedia.com/index.php/Rs1799752 https://pubmed.ncbi.nlm.nih.gov/21330423/
UPDATE variant SET identifier='rs1801133' WHERE ((identifier='C677T' OR identifier='677C/T') AND gene_id=(SELECT id FROM gene WHERE symbol='MTHFR'));  -- rs1801133, https://www.snpedia.com/index.php/MTHFR rs1801133, also known as C677T or A222V
UPDATE variant SET identifier='rs7412' WHERE (identifier='E2/E3/E4' AND gene_id=(SELECT id FROM gene WHERE symbol='APOE'));  -- rs7412,rs429358 https://www.snpedia.com/index.php/APOE  There are three relatively common allelic variants of ApoE, as defined by two SNPs, rs429358 and rs7412 known as ApoE-ε2, ApoE-ε3, and ApoE-ε4
UPDATE variant SET identifier='rs1800790' WHERE (identifier='-455G/A' AND gene_id=(SELECT id FROM gene WHERE symbol='FGB')); -- https://www.snpedia.com/index.php/Rs1800790 Also known as 455G/A beta Fibrinogen polymorphism. A is the risk allele according to the following paper: 
UPDATE variant SET identifier='rs2430561' WHERE (identifier='874T/A' AND gene_id=(SELECT id FROM gene WHERE symbol='IFNG')); -- 874T/A -> rs2430561 https://www.archivesofmedicalscience.com/IFN-874-A-T-rs2430561-gene-polymorphism-and-risk-of-pulmonary-tuberculosis-a-meta,78642,0,2.html https://www.snpedia.com/index.php/Rs2430561
UPDATE variant SET identifier='rs662' WHERE (identifier='Q192R' AND gene_id=(SELECT id FROM gene WHERE symbol='PON1')); -- Q192R -> Rs662, https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6074118/ A single nucleotide polymorphism (SNP) in the PON1 gene, Q192R (rs662) https://www.snpedia.com/index.php/Rs662
UPDATE variant SET identifier='rs1800896' WHERE (identifier='-1082G/A' AND gene_id=(SELECT id FROM gene WHERE symbol='IL10')); -- -1082G/A -> rs1800896, https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5658633/ https://www.snpedia.com/index.php/Rs1800896 This SNP is upstream of the IL10 gene, and is also known as the -1082G>A IL10 SNP
UPDATE variant SET identifier='rs1008438' WHERE (identifier='-110A/C' AND gene_id=(SELECT id FROM gene WHERE symbol='HSPA1A')); -- ## -110A/C -> rs1008438, https://pubmed.ncbi.nlm.nih.gov/22328194/  https://www.snpedia.com/index.php/Rs1008438
UPDATE variant SET identifier='rs1799963' WHERE (identifier='20210G/A' AND gene_id=(SELECT id FROM gene WHERE symbol='F2')); -- ## 20210G/A -> Rs1799963 https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4465517/ https://www.snpedia.com/index.php/Rs1799963 rs1799963 is a SNP far more commonly known as the G20210A mutation of the prothrombin F2 gene. 23andMe's i3002432 is another name for rs1799963. 
UPDATE variant SET identifier='rs2069762' WHERE (identifier='-330T/G' AND gene_id=(SELECT id FROM gene WHERE symbol='IL2')); -- https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4514317/
...
INSERT INTO gene(id,name,symbol,alias,description,omim,ensembl,uniprot,unigene,cytogenetic_location)
	VALUES (5265,'serpin family A member 1','SERPINA1','PI A1A AAT PI1 A1AT nNIF PRO2275 alpha1AT', 
			...
			107400, 'ENSG00000197249', 'A1AT_HUMAN', 525557, '14q32.13');		-- serpina1 gene info
UPDATE variant SET identifier='rs28940579',gene_id=(SELECT id FROM gene WHERE symbol='SERPINE1') WHERE (identifier='SERPINE1' AND gene_id=(SELECT id FROM gene WHERE symbol='SERPINE1')); -- https://www.snpedia.com/index.php/Rs28929474 
...
--- REMOVAL BY ERROR ---
UPDATE variant SET identifier=NULL WHERE (identifier='rs3918188rs3918226');
UPDATE variant SET association='non-significant' WHERE (association='Non-significant');
INSERT INTO gene(id,name,symbol) VALUES (0, '', '');
UPDATE variant SET gene_id = 0 WHERE gene_id is NULL; 
